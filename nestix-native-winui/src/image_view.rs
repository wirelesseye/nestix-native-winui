...
use nestix_native_core::{
    AnimatedStyle, ImageViewProps, StyleContext, TreeContext, WithAuto, matched_style,
...
pub fn ImageView(props: &ImageViewProps, element: &Element) {
    ...
    image
        .set_intrinsic_size_changed(callback!([set_intrinsic_size] |width: f32, height: f32| {
