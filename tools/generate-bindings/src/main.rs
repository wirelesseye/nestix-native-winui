...
fn main() {
    ...
    args.extend([
        ...
        "Microsoft.UI.Composition.SystemBackdrops.MicaKind".to_string(),
        ...
        "Microsoft.UI.Xaml.Controls.NavigationViewPaneClosingEventArgs".to_string(),
